...
export function Hero() {
  const features = [
    ...
    },
    {
      ...
      className: "col-span-1 lg:col-span-3 border-b lg:border-none h-[20rem] lg:h-full",
    },
  ];
  return (
  ...
  return (
    <p
      className={cn(
        ...
        "text-left max-w-sm mx-0 md:text-sm my-0 md:my-2"
      )}
    >
      {children}
    </p>
...
export const SkeletonTwo = () => {
  ...
  return (
    <div className="relative flex flex-col items-start p-8 gap-10 object-cover h-full overflow-hidden">
      {/* TODO */}
...
export const SkeletonFour = () => {
  return (
    <div className="md:h-60 h-60  flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10">

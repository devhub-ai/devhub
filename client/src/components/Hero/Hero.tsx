...
export function Hero() {
  const features = [
    ...
    },
    {
      ...
      className: "col-span-1 lg:col-span-3 border-b lg:border-none h-[35rem]",
    },
  ];
  return (
    <div className="relative z-20 py-20 lg:py-20 max-w-7xl mx-auto">
      <div className="relative ">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-6 xl:border rounded-md dark:border-neutral-800 h-[120rem] md:h-[140rem] lg:h-[60rem]">
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      ...
      <div className="absolute bottom-0 z-40 inset-x-0 h-60 lg:bg-gradient-to-t from-white dark:from-black via-white dark:via-black to-transparent w-full pointer-events-none" />
      <div className="absolute top-0 z-40 inset-x-0 h-60 lg:bg-gradient-to-b from-white dark:from-black via-transparent to-transparent w-full pointer-events-none" />
    </div>
  );
};
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60 flex flex-col items-center relative bg-transparent dark:bg-transparent lg:mt-40">
      <Globe className="absolute -right-10 md:-right-10 -bottom-52 md:-bottom-62 lg:-bottom-20 sm:p-9" />
    </div>
  );
};

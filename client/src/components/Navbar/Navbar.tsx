  ...
  return (
    <div className="relative">
      <Dock magnification={60} distance={100}>
        ...
        <DockIcon className="bg-black/10 dark:bg-white/10 p-3">
          <Icons.gitHub className="size-full" onClick={gotoGithub} />
        </DockIcon>
        <DockIcon className="bg-black/10 dark:bg-white/10 p-3">
          <Icons.Discord className="size-full" onClick={gotoDiscord} />
        </DockIcon>
      </Dock>
    </div>
  );
...
const Icons = {
  ...
  Devhub: (props: IconProps) => (
    <img
      src="https://i.ibb.co/xLbC5K7/logo.png"
      alt="Devhub"
      {...props}
    />
  ),

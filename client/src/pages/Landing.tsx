...
const Landing: React.FC = () => {
  return (
    <div className="w-full rounded-md md:items-center md:justify-center antialiased bg-grid-white/[0.02] relative overflow-hidden dark:bg-zinc-900 bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] items-center justify-center">
